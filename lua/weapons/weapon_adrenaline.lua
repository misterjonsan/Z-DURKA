...
SWEP.Instructions = "Адреналин, также известный как эпинефрин, — это гормон и лекарственное средство, участвующее в регуляции висцеральных (внутренних) функций. Используйте его для повышения артериального давления и/или остановки сердечного приступа. Нажмите правую кнопку мыши (ПКМ), чтобы ввести препарат кому‑либо"
