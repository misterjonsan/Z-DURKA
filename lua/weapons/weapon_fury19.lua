...
SWEP.PrintName = "Fury-19"
SWEP.Instructions = "ЯРИК ПРАЙМ"
...
if SERVER then
	function SWEP:Heal(ent, mode)
		...
		if !ent.PlayerClassName or ent.PlayerClassName != "furry" then
			-- Делаем усиление бесконечным, устанавливая таймер на очень большое значение (99999 секунд)
			org.berserk = CurTime() + 99999
		else
			org.o2["curregen"] = 0
			org.o2["regen"] = 0
			org.poison4 = CurTime()
