...
function MODE:HUDPaint()
	...
	if StartTime + 20 > CurTime() then
		...
		draw.SimpleText( "Нажмите F3 чтобы закупится.", "ZB_HomicideMedium", sw * 0.5, sh * 0.9, Color(255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	else
    ...
    draw.SimpleText("ZBattle | "..(self.PrintName or "Командный Бой Насмерть"), "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0,162,255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
