...
MODE.Types.wildwest = {
	...
	LootTable = MODE.LootTableStandard,
	Messages = {
		[3] = "Мертвая тишина заполонила город...",
		[1] = "Город пал в руки беззаконицы.",
		[0] = "Закон восстановил порядок. Убийца был",
	},
	Message = "Убийца был  ",
	TraitorLoot = function(ply)
...
MODE.Types.soe = {
	...
	PoliceText = "Национальная гвардия явилась.",
...
function MODE:EndRound()
	...
	if self.Type then
		if(MODE.RoleChooseRound)then
			if(winner ~= 1)then
				PrintMessage(HUD_PRINTTALK, "Все душманы остановлены.")
				...
				PrintMessage(HUD_PRINTTALK, "Все невиновные были убиты.")
			end
