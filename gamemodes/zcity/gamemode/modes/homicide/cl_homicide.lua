...
MODE.TypeNames = {
	["standard"] = "Стандарт",
	["soe"] = "Штатный режим (SOE)",
	["gunfreezone"] = "Алапульское бревно (без оружий)",
...
MODE.TypeObjectives.soe = {
	traitor = {
		objective = "Ты убийца. Уничтожь всю улицу громил или будь погромён.",
		name = "Убийца",
	...
	gunner = {
		objective = "Ты мигрант из Техаса в улицу громил. Убей убийцу пока он тебя не погромил.",
		name = "Вооружёный.",
	...
	innocent = {
		objective = "Ты невинный житель Грозного, спаси себя либо спаси других и умри.",
		name = "Невинный",
		color1 = Color(0,120,190)
	},
}
...
MODE.TypeObjectives.standard = {
	traitor = {
		objective = "Ты родился бобом и решил всех убить. Убей всех или будь погромён.",
		name = "Душман",
		color1 = Color(190,0,0),
		color2 = Color(190,0,0)
	},
	...
	gunner = {
		objective = "Ты невинный со спрятанным оружием в кармане. Убей убийцу либо агрессивного школяра.",
		name = "Любитель Страйкбола",
		color1 = Color(0,120,190),
		color2 = Color(158,0,190)
	},

	innocent = {
		objective = "Ты невинный дурачок. Спаси свою жирную тушу или тебя пустят на мясокомбинат.",
		name = "Невиновный",
		color1 = Color(0,120,190)
	},
}
...
MODE.TypeObjectives.wildwest = {
	traitor = {
		objective = "Ты наиграл в рдр2 более 2-х часов.",
		name = "Техасский стрелок",
		color1 = Color(190,0,0),
		color2 = Color(190,0,0)
	},

	gunner = {
		objective = "Ты шериф города Dickensk. Спаси жителей либо будь застрелен одним из них.",
		name = "Шериф",
		color1 = Color(0,120,190),
		color2 = Color(158,0,190)
	},
	...
	innocent = {
		objective = "Старина Билли решил всех перестрелять, найди КТО этот старина билли из толпы людей.",
		name = "Ковбой",
		color1 = Color(0,120,190),
		color2 = Color(158,0,190)
	},
...
MODE.TypeObjectives.gunfreezone = {
	traitor = {
		objective = "Ты снабжён оружием, погроми всех тут.",
		name = "Убийца",
		color1 = Color(190,0,0),
		color2 = Color(190,0,0)
	},
	...
	gunner = {
		objective = "Ты невиновный паренёк с улицы громил.",
		name = "Невиновный",
		color1 = Color(0,120,190)
	},
...
MODE.TypeObjectives.suicidelunatic = {
	...
	gunner = {
		objective = "ЕБУЧИЙ БИСМИЛЛЯХ РАЗГНЕВАЛСЯ!!! УБЕЙ ЕГО ДО ТЕХ ПОР ПОКА ОН ВСЕХ НЕ ВЗОРВАЛ.",
		name = "Солдат США",
		color1 = Color(0,120,190)
	},

	innocent = {
		objective = "БИСМИЛЛЯХ РАЗГНЕВАЛСЯ, СПАСАЙСЯ.",
		name = "Гражданский",
		color1 = Color(0,120,190)
	},
}
...
CreateEndMenu = function(traitor)
	...
	hmcdEndMenu.PaintOver = function(self,w,h)
		...
		surface.DrawText(traitorName .. " бульба ("..traitorNick..")")
	end
