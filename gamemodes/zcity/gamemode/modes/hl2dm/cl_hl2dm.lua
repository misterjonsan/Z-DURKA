...
local teams = {
	[0] = {
		objective = "Убей всех солдат Альянса.",
		name = "Повстанец",
	...
	[1] = {
        ...
        name_shotgunner = "Солдат Альянса",
...
function MODE:HUDPaint()
    ...
    draw.SimpleText("ZBattle | Half-Life 2 Бой Насмерть", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    ...
    draw.SimpleText("Ты " .. role_data.name, "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.5, role_data.color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
